...
if strcmp(BC,'simply-simply') 
    lamda(1:N)=(1:N)*pi;%simply-supported 杩欎釜鍏�?寰楀埌鐨勭壒寰?鍊兼槸绮惧噯瑙�
...
%  杩欎釜鍏�?寰楀埌鐨勭壒寰?鍊兼槸杩戜技瑙ｏ紝绮惧害涓?楂橈紝鐩存帴姹傜壒寰?鏂圭▼鐨勮В姣旇緝濂�
...
% lamda(3:N)=(3:N)*pi-0.5*pi;% 杩欎釜鍏�?寰楀埌鐨勭壒寰?鍊兼槸杩戜技瑙ｏ紝绮惧害涓?楂橈紝鐩存帴姹傜壒寰?鏂圭▼鐨勮В姣旇緝濂�
end
intphi = zeros(N,1);
for n=1:N
   if strcmp(BC,'simply-simply') 
...
% 鎮噦姊?鐨勭壒寰?鍑芥暟姣旇緝澶?�?傦紝鍦ㄦ眰int锛坒锛寈,0,x锛夌殑鏃跺€欒�?涔堣绠楀緢鎱紝瑕?涔堟棤娉曠畻鍑恒€�
%鍥犳闇€瑕?鏀规?㈡€?璺紝涓?鐢╩atlab杩涜绉垎鎿?浣滐紝鑰屾槸鍦╩aple涓绠楀嚭�?ワ紝鐒跺?庡湪matlab涓�?�
