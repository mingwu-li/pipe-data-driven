...
You are supposed to install SSMLearn [2] first and then add misc folder here to MATLAB path. Now, you are ready to run the examples to reproduce the results in our manuscript.
